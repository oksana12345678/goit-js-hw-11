import{S as p}from"./assets/vendor-870f0eb5.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function o(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(t){if(t.ep)return;t.ep=!0;const r=o(t);fetch(t.href,r)}})();const a=document.querySelector(".gallery"),d=new p(".gallery a",{captionsData:"alt",captionDelay:250});d.refresh();function m(s){a.innerHTML="",s.forEach(e=>{const o=`
    ...
    `;a.insertAdjacentHTML("beforeend",o)}),d.refresh()}const h=document.querySelector(".form"),c=document.querySelector(".search-input"),u=document.querySelector(".loader"),y="42710952-cb07850fe6c5f6774b64d780f",g="https://pixabay.com/api/";async function L(s){const e=`${g}?key=${y}&q=${s}&image_type=photo&orientation=horizontal&safesearch=true`;return(await(await fetch(e)).json()).hits}f();h.addEventListener("submit",b);async function b(s){s.preventDefault(),l();const e=c.value.trim();if(e===""){iziToast.error({title:"Error",message:"Please enter a search term.",position:"topCenter"});return}l();try{const o=await L(e);o.length===0?iziToast.info({title:"Info",message:"Sorry, there are no images matching your search query. Please try again!",position:"topCenter"}):(m(o),c.value="")}catch(o){console.error("Error fetching images:",o),iziToast.error({title:"Error",message:"Failed to fetch images. Please try again later.",position:"topCenter"})}finally{f()}}function l(){u.classList.remove("hidden")}function f(){u.classList.add("hidden")}
